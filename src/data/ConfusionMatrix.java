...
public class ConfusionMatrix
{
    ...
    protected TreeSet<String> allGoldLabels = new TreeSet<String>();

    protected TreeSet<String> allPredictedLabels = new TreeSet<String>();

    protected List<String> labelSeries = new ArrayList<String>();
